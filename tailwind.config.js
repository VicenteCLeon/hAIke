...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Tokens basados en variables CSS (definidas en globals.css) para
        // soportar tema oscuro (por defecto) y claro. El formato
        // `rgb(var(--x) / <alpha-value>)` mantiene los modificadores de opacidad.
      ...
      fontFamily: {
        ...
        'technical-mono': ['DM Sans', 'sans-serif'],
      ...
      fontSize: {
        ...
        'headline-lg-mobile': ['30px', { lineHeight: '38px', fontWeight: '400' }],
        ...
        'technical-mono': ['12px', { lineHeight: '16px', letterSpacing: '0.1em', fontWeight: '700' }],
